...
export default function Sidebar({ open, onClose }: { open: boolean; onClose: () => void }) {
  return (
    <>
      ...
      >
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200"><img src="https://raw.githubusercontent.com/yalugagenda-hash/gestaofaxinas/refs/heads/main/logo.png" alt="Logo" className="h-16 w-auto" />
